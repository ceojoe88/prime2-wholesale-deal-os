  ...
  return (
    <div className="page">
      <PageHeader
        ...
        description="Prime 2 routes hot deals, underwriting gaps, buyer-ready opportunities, stale follow-ups, and compliance blockers."
      />
        ...
        <Section title="Next Best Actions">
          <div className="record-list">
            {[
              ...
              ["normal", "Review daily command briefing", `${dailyCommandBriefings.length} Prime 2 briefing generated by V12`],
