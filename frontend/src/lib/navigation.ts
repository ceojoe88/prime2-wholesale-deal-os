export const dashboardRoutes = [
  ...
  { href: "/dashboard/client-command/onboarding", label: "Client Onboarding", icon: "ClipboardList" },
  { href: "/dashboard/client-command/plans", label: "Client Plans", icon: "BadgeDollarSign" },
  { href: "/dashboard/client-command/communication", label: "Client Communication", icon: "Command" },
  { href: "/dashboard/client-command/billing", label: "Client Billing", icon: "CircleDollarSign" },
  { href: "/dashboard/client-command/pilot", label: "Client Pilot", icon: "ListChecks" },
