...
def add_memphis_client_demo(payload: dict[str, list[dict[str, object]]]) -> None:
    """Add the CP1-CP4 Memphis demo scenario for pre-CP5 walkthroughs."""
    ...
    payload["client_workspaces"].append(
        {
            ...
            "allowed_permissions": CLIENT_COMMAND_PERMISSIONS,
            "safety_rules": [
                "Demo/local CP1-CP4 client command scenario only.",
                "No outbound provider actions, offers, contracts, billing, or live outreach.",
                "Buyer matching remains a future CP5-ready handoff state.",
            ],
            "onboarding_notes": "Five-lead Memphis demo scenario for client-safe acquisition and underwriting walkthroughs.",
            "internal_prime_governance_visible": False,
            "raw_provider_payload_exposure_allowed": False,
            "admin_only_controls_visible": False,
            "live_outreach_enabled": False,
