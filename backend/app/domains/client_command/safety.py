...
CLIENT_COMMAND_BLOCKED_ACTIONS = {
    "sms_send": "Client command CP1-CP7 cannot send SMS.",
    "email_send": "Client command CP1-CP7 cannot send email.",
    "voice_call": "Client command CP1-CP7 cannot place voice calls.",
    "buyer_blast": "Client command CP1-CP7 cannot blast buyers.",
    "seller_blast": "Client command CP1-CP7 cannot blast sellers.",
    "campaign_launch": "Client command CP1-CP7 cannot launch campaigns.",
    "buyer_scraping": "Client command CP1-CP7 cannot scrape or pull buyer lists.",
    "skip_trace_provider_call": "Skip-trace provider calls are unavailable in CP1-CP7.",
    "dnc_check_provider_call": "DNC provider calls are unavailable in CP1-CP7.",
    "ten_dlc_live_registration": "10DLC live registration is unavailable in CP1-CP7.",
    "live_comp_property_data_pull": "Live comp, property, tax, title, and MLS provider pulls are unavailable in CP1-CP7.",
    "tax_title_provider_call": "Tax and title provider calls are unavailable in CP1-CP7.",
    "mls_call": "MLS calls are unavailable in CP1-CP7.",
    "stripe_charge": "Billing and payment actions are unavailable in CP1-CP7.",
    "invoice_action": "Invoice actions are unavailable in CP1-CP7.",
    "contract_generation": "Contract generation is unavailable in CP1-CP7.",
    "contract_esignature_send": "Contract and e-signature sends are unavailable in CP1-CP7.",
    "provider_sync": "Provider sync actions are unavailable in CP1-CP7.",
    "autonomous_fulfillment": "Autonomous fulfillment is unavailable in CP1-CP7.",
...
def client_command_safety_rules() -> dict[str, object]:
    return {
        "phase": "CP1-CP7 controlled client command operating system",
