...
BLOCKED_ACTIONS = {
    ...
    "auto_execute_without_rule": "V13 auto-execution requires an approved rule.",
    "auto_execute_without_template": "V13 auto-execution requires an approved safe template.",
    "auto_execute_bulk_campaign": "V13 auto-execution blocks bulk campaigns.",
    "auto_execute_buyer_blast": "V13 auto-execution blocks buyer blasts.",
    "auto_execute_cold_sms": "V13 auto-execution blocks cold SMS automation.",
    "auto_execute_legal_contract_message": "V13 auto-execution blocks legal or contract messages.",
    "buyer_acceleration_bulk_blast": "V14 buyer acceleration blocks bulk buyer blasts and campaign sends.",
    "buyer_acceleration_live_without_gates": "V14 controlled buyer sends require V5/V13 gates, owner approval, and one recipient.",
    "buyer_acceleration_fake_scarcity": "V14 buyer acceleration blocks misleading scarcity and fake competition.",
    "buyer_acceleration_seller_data_leak": "V14 buyer deal sheets must not expose seller/private source data.",
    "buyer_acceleration_internal_profit_leak": "V14 buyer acceleration must not expose internal spread or assignment-fee strategy.",
    "optimization_without_source_evidence": "V15 learning records require source evidence before influencing recommendations.",
    "optimization_fake_revenue_claim": "V15 optimization blocks fake revenue, guaranteed revenue, or unsupported assignment-fee claims.",
    "optimization_unsupported_roi": "V15 optimization blocks unsupported ROI claims.",
    "optimization_black_box_scoring": "V15 scoring changes must be deterministic, explainable, and logged.",
    "forecast_guaranteed_revenue": "V16 forecasts are estimates and must not guarantee revenue or profit.",
    "forecast_unsupported_roi": "V16 blocks unsupported ROI and invented close-probability claims.",
    "forecast_without_source_records": "V16 revenue and spend forecasts must reference evidence/source records.",
    "unsupported_lead_spend": "V16 lead spend recommendations require evidence basis and owner review.",
    "semi_autonomous_bypass_approval": "V17 semi-autonomous mode cannot bypass owner approvals.",
    "semi_autonomous_level_5": "V17 Level 5 remains disabled.",
    "semi_autonomous_contract_execution": "V17 cannot execute contracts.",
    "semi_autonomous_title_submission": "V17 cannot submit to title companies.",
    "semi_autonomous_bulk_campaign": "V17 cannot send bulk campaigns.",
    "semi_autonomous_payment_handling": "V17 cannot handle payments.",
    "semi_autonomous_term_change": "V17 cannot change seller or buyer terms.",
    "production_real_provider_call_without_sandbox": "V18 blocks real provider calls unless sandbox readiness and explicit gates are satisfied.",
    "production_public_exposure_without_auth": "V18 blocks public production exposure until owner-only auth and deployment hardening are complete.",
    "export_raw_private_data": "V18 audit and backup exports must sanitize seller, buyer, secret, and internal fields.",
    "commit_provider_secret": "Provider secrets must never be committed; configure secrets outside the repository.",
    "backup_raw_private_data": "V18 backup exports expose safe metadata only unless a future owner-approved secure export exists.",
...
def system_rules() -> dict[str, object]:
    return {
        ...
        "auto_execution": {
            "approved_rule_required": True,
            "approved_template_required": True,
            "single_recipient_only": True,
            "bulk_campaigns": False,
            "buyer_blasts": False,
            "cold_sms_automation": False,
            "legal_contract_messages": False,
        },
        "buyer_acceleration": {
            "draft_sequences_default": True,
            "controlled_send_requires_v5_v13_gates": True,
            "single_recipient_only": True,
            "bulk_blasts": False,
            "seller_private_data_exposure": False,
            "internal_profit_logic_exposure": False,
            "deceptive_scarcity": False,
        },
        "optimization_learning": {
            "source_evidence_required": True,
            "deterministic_explainable_scoring": True,
            "scoring_changes_logged": True,
            "black_box_ml": False,
            "guaranteed_revenue_claims": False,
            "unsupported_roi_claims": False,
        },
        "revenue_forecast": {
            "forecasts_are_estimates": True,
            "source_records_required": True,
            "guaranteed_profit": False,
            "unsupported_roi": False,
            "invented_probabilities": False,
            "owner_review_required_for_spend": True,
        },
        "operator_mode": {
            "available_modes": ["manual", "assisted", "near_autonomous", "semi_autonomous"],
            "semi_autonomous_default": False,
            "owner_approval_console_required": True,
            "level_5_available": False,
            "contract_execution": False,
            "title_submission": False,
            "bulk_campaigns": False,
            "payment_handling": False,
            "portal_publish_without_approval": False,
        },
        "production_readiness": {
            "audit_exports_sanitized": True,
            "safe_backup_metadata_only": True,
            "attachment_source_linkage_required": True,
            "provider_sandbox_default_blocked": True,
            "public_exposure_without_auth": False,
            "secrets_committed": False,
            "raw_private_data_in_unsafe_exports": False,
        },
